...
<h3 id='PL1'>Python package license-related metadata should be OSI-approved</h3>


|   id  | applies to | category | related to |
|  :---:  | :---: | :---: | :---: |
|`[PL1]`| Python packages | OSS | [`[001]`](#001)
...
<!--
The following list of validations is generated by `python manager.py cli update_validation_list`
DIRECT CHANGES ARE GOING TO BE OVERWRITTEN AUTOMATICALLY
Submit an issue if you want to change something
-->

<!-- start:validation-list -->---

<h3 id="C09">All members should a category in the <code>group</code> entry</h3>
...
<h3 id="C10">Member's category should be valid</h3>
...
<h3 id="L09">Members should have, at least, one label</h3>
...
<h3 id="L10">All the labels for a member should be valid</h3>
